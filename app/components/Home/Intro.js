        ...
        <div className="py-10">
            <ScreenTransition ScrollY={0} delay={"500"} arrow={1}>
                <div className="text-3xl flex justify-center pb-2">Short introduction</div>                
                    <div className="p-2">
                    Born in portugal, Started coding at 16 and haven't stopped since. I've always had a keen interest in understanding how things work. When it came time to choose my career path, I had two options in mind: mechanics or programming.
                    </div>
                    <div className="p-2">
